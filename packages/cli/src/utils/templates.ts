...
// Component templates - auto-generated by scripts/generate-templates.ts
// Run `pnpm generate-templates` to regenerate
import COMPONENT_TEMPLATES from './component-templates.json' with { type: 'json' };

export const TEMPLATES: Record<string, Record<string, string>> = COMPONENT_TEMPLATES;
